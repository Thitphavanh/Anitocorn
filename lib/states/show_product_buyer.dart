                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ShowTitle(
                                title:
                                    'Price = ${productModels[index].price} LAK',
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          title: ListTile(
            leading: ShowImage(path: MyConstant.avatar),
            title: ShowTitle(
              title: productModel.name,
              textStyle: MyConstant().h2Style(),
            ),
            subtitle: ShowTitle(
              title: 'Price = ${productModel.price} LAK',
              textStyle: MyConstant().h3Style(),
            ),
          ),
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Icon(Icons.filter_1, color: MyConstant.lightblue),
                      ),
                      IconButton(
                        onPressed: () {
                          setState(() {
                        ...
                        icon: Icon(Icons.filter_2, color: MyConstant.lightblue),
                      ),
                      IconButton(
                        onPressed: () {
                          setState(() {
                        ...
                        icon: Icon(Icons.filter_3, color: MyConstant.lightblue),
                      ),
                      IconButton(
                        onPressed: () {
                          setState(() {
                        ...
                        icon: Icon(Icons.filter_4, color: MyConstant.lightblue),
                      ),
                    ],
                  ),
                ),
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    if ((currentIdSeller == idSeller) ||
                      ...
                      Navigator.pop(context);
                      Navigator.pop(context);
                      MyDialog().normalDialog(context, 'ຮ້ານຜິດ ?',
                          'ກະລຸນາເລືອກສິນຄ້າ ທີ່ຮ້ານເກົ່າ ໃຫ້ສຳເລັດກ່ອນ ເລືອກຮ້ານອື່ນ ເຈົ້າ');
                    }
                  },
                  child: Text(
                    'Add Cart',
