...
class _EditProfileSalerState extends State<EditProfileSaler> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit Proflie Saler'),
        actions: [
          IconButton(
            onPressed: () => procressEditProfileSeller(),
  ...
  Future<Null> procressEditProfileSeller() async {
    print('procressEditProfileSeller Work');
  ...
  Future<Null> editValueToMySQL(String pathAvatar) async {
    ...
    String apiEditProfile =
        '${MyConstant.domain}/shoppingmall/editProfileSellerWhereId.php?isAdd=true&id=${userModel!.id}&name=${nameController.text}&address=${addressController.text}&phone=${phoneController.text}&avatar=$pathAvatar';
          ...
          child: Row(
            children: [
              IconButton(
                ...
                icon: Icon(Icons.add_a_photo, color: MyConstant.darken),
              ),
              Container(
